...
multi_scm <- function(gt_state_list, chr_str, h5f_path, tree, Q,
  ...
  # specifying which argument is missing
  if (missing(gt_state_list)) {
    return(print("ERROR: 'gt_state_list' must be provided."))
  }
  if (missing(chr_str)) {
    return(print("ERROR: 'chr_str' must be provided."))
  }
  if (missing(h5f_path)) {
    return(print("ERROR: 'h5f_path' must be provided."))
  }
  if (missing(tree)) {
    return(print("ERROR: 'tree' must be provided."))
  }
  if (missing(Q)) {
